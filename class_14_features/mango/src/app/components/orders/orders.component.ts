...
export class OrdersComponent implements OnInit {
  ...
  async handleCancellation(orderId: number) {
    const confirmation = await this.confirmationService.confirm(
      this.translate.instant('orders.confirmCancelTitle', { id: orderId }),
      this.translate.instant('orders.confirmCancelMessage'),
      this.translate.instant('orders.confirmCancelLabel'),
    );
