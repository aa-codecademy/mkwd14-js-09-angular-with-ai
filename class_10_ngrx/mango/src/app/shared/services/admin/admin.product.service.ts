...
import type { CreateOrUpdateProduct, Product } from '../../../core/models/product.model';
...
export class AdminProductService {
  ...
  create(body: CreateOrUpdateProduct): Observable<Product> {
    return this.httpClient.post<Product>(`${this.apiUrl}/products`, body);
  }

  update(body: CreateOrUpdateProduct, id: number): Observable<Product> {
    return this.httpClient.put<Product>(`${this.apiUrl}/products/${id}`, body);
  }
}
